...
TARGET_PROJECT_DIR="${PROJECT_BASE_DIR}/subprojects/domain-model"
...
run_generate() {
  $PROJECT_BASE_DIR/$SCRIPTS_DIR/generate-domain-model.sh
}
# @main@
...
show_usage () {
cat << 'END'
Usage: ./scripts/publish-local-domain-model.sh [OPTION]...
  -h, --help
